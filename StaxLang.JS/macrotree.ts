...
export class MacroTreeNode {
    ...
    addMacro(types: string, code: string) {
...
function setup() {
    const macros = [
        ...
        { alias: "/", types: "ai", code: "n%%b(aat"},
        { alias: "/", types: "ia", code: "sn%%b(aat"},
        ...
        { alias: "M", types: "a", code: "|R{HoHh"},
        { alias: "o", types: "aa", code: "Vi|\\{|Mm"},
        { alias: "p", types: "i", code: "v{|p}gsv"},
